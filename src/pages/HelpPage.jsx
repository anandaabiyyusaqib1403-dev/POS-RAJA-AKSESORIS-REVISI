...
const guides = [
  ...
  },
  {
    ...
    tip: "Review shift setiap akhir hari agar laporan profit tidak tertunda.",
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      "Cek harga jual, modal, dan profit.",
  ...
  {
    id: "financial-report",
    title: "Membaca Laporan Profit",
    category: "laporan",
    audience: "owner",
    time: "5 menit",
    description: "Pahami omzet, modal, profit, pengeluaran, dan performa toko.",
    tags: ["laporan", "profit", "omzet", "modal", "export"],
    steps: [
      "Buka Laporan Keuangan atau Laporan Penjualan.",
      "Pilih periode laporan.",
      "Cek omzet dan modal.",
      "Bandingkan profit dengan pengeluaran operasional.",
      "Cek produk, layanan, provider, dan kasir terbaik.",
      "Export laporan jika dibutuhkan.",
    ],
    warning: "Profit akurat hanya jika modal produk dan modal layanan diinput benar.",
