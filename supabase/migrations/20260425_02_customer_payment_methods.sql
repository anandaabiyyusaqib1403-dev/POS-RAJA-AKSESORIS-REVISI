-- Customer payment method expansion and external app source restriction.

alter type public.nama_platform add value if not exists 'gopay_customer';
alter type public.nama_platform add value if not exists 'gopay_driver';
alter type public.nama_platform add value if not exists 'grab_customer';
alter type public.nama_platform add value if not exists 'grab_driver';
alter type public.nama_platform add value if not exists 'isaku_indomaret';
alter type public.nama_platform add value if not exists 'shopee_food_driver';
alter type public.nama_platform add value if not exists 'maxim_driver';
alter type public.nama_platform add value if not exists 'linkaja';
alter type public.nama_platform add value if not exists 'in_driver';
alter type public.nama_platform add value if not exists 'etoll_emoney_mandiri';
alter type public.nama_platform add value if not exists 'etoll_brizzi';
alter type public.nama_platform add value if not exists 'etoll_tapcash_bni';

alter type public.metode_bayar add value if not exists 'gopay_customer';
alter type public.metode_bayar add value if not exists 'gopay_driver';
alter type public.metode_bayar add value if not exists 'grab_customer';
alter type public.metode_bayar add value if not exists 'grab_driver';
alter type public.metode_bayar add value if not exists 'isaku_indomaret';
alter type public.metode_bayar add value if not exists 'shopee_food_driver';
alter type public.metode_bayar add value if not exists 'maxim_driver';
alter type public.metode_bayar add value if not exists 'linkaja';
alter type public.metode_bayar add value if not exists 'in_driver';
alter type public.metode_bayar add value if not exists 'etoll_emoney_mandiri';
alter type public.metode_bayar add value if not exists 'etoll_brizzi';
alter type public.metode_bayar add value if not exists 'etoll_tapcash_bni';
...
begin
  ...
  v_deduct_platform := case
    when v_source_platform::text not in (
      'cash',
      'qris',
      'split',
      'gopay_customer',
